...
export default class FindRestaurantScreen extends Component {
     constructor(props){
         super(props)
         this.state = {
             input: ''
             ...
             <ScrollView style = {{backgroundColor:'white'}}>
                ...
                <View 
                    ...
                    <TouchableOpacity style = {{flex:1}}>
                        <View style = {Styles.buttonSearch}>
                            <Text style={{color:'white'}}>Find Restaurants</Text>
                        </View>
                    </TouchableOpacity>
                ...
                <View style={{margin:10}}>
                    <View style={{flex:1, flexDirection: 'row', justifyContent:'space-between', alignItems:'flex-end', marginBottom:10}}>
                            <Text style={{fontWeight:'bold', fontSize:20}}>Tốp ăn uống</Text>
                            <Text 
                ...
                <View style={{margin:10}}>
                    <View style={{flex:1, flexDirection: 'row', justifyContent:'space-between', alignItems:'flex-end', marginBottom:10}}>
                            <Text style={{fontWeight:'bold', fontSize:20}}>Nhà hàng gia đình</Text>
                            <Text 
                                style= {{color:'#ED50C6'}} onPress={()=>{console.log('press see all top hotel...')}}>See all</Text>
                    </View>
                    <FlatList
                ...
                <View style={{margin:10}}>
                    <View style={{flex:1, flexDirection: 'row', justifyContent:'space-between', alignItems:'flex-end', marginBottom:10}}>
                            <Text style={{fontWeight:'bold', fontSize:20}}>Quán cafe phong cách lãng mạn</Text>
                            <Text 
                                style= {{color:'#ED50C6'}} onPress={()=>{console.log('press see all top hotel...')}}>See all</Text>
                    </View>
                    <FlatList
